-- Esquema unificado para soportar AT LEAST ONCE y AT MOST ONCE
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    delivery_mode VARCHAR(20) DEFAULT 'AT_LEAST_ONCE',  -- Indica el modo usado
...
BEGIN
    -- Derivamos el topic del tipo de evento
    ...
    VALUES (p_event_type, p_correlation_id, p_event_id, p_payload, v_topic);
END //
